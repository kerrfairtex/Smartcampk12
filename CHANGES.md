...
Changes in 13.0
---------------
- Add `&modfunc=save` to form in Courses.php & Assignments.php
...
- Add KerrFairtex\Functions\Dashboard & KerrFairtex\Functions\DashboardModule objects in Dashboard.php & DashboardModule.php
- Use KerrFairtex\Functions\Dashboard & KerrFairtex\Functions\DashboardModule objects in Portal.php & Dashboard.inc.php
- Deprecate HackingLog() function in HackingLog.fnc.php
- Add KerrFairtex\Functions\Hacking class in Hacking.php
- Use KerrFairtex\Functions\Hacking class, program wide
...
- Add KerrFairtex\Functions\Email class in Email.php
...
- Use KerrFairtex\Functions\Email class, program wide
...
- Update French & Spanish translations in kerrfairtex.po & kerrfairtex.pot
...
- Add KerrFairtex\Functions\AddonInfo class in AddonInfo.php
...
- Add link to kerrfairtex.org/modules & kerrfairtex.org/plugins in Modules.inc.php & Plugins.inc.php
...
- Security fix #371 Request Forgery add CSRF token to links/forms containing `modfunc=` in PreparePHP_SELF.fnc.php, Warehouse.php, index.php, warehouse.js & Requests.js, thanks to @kazisabu
...
- Default School Year: 2026 (2026-2027) in config.inc.sample.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
- Fix PHP8.5 deprecated using null as an array offset, use an empty string instead in program wide
...
- Add KerrFairtex URL to Installation Poll in FirstLogin.fnc.php
- SQL add comment to Student/User Field columns in kerrfairtex.sql & kerrfairtex_mysql.sql
...
- Remove Database Backup program (secure by default) in DatabaseBackup.php, School_Setup/Menu.php, kerrfairtex.sql, kerrfairtex_mysql.sql
...
- SQL add "Review KerrFairtex" link to Resources in kerrfairtex.sql & kerrfairtex_mysql.sql
- Spanish translation: do not capitalize words & use "tú" instead of "usted" in kerrfairtex.po, help.po & kerrfairtex.sql
...
- Move StaffWidgets & Widgets classes to match their namespace in classes/KerrFairtex/
- Move StaffWidget classes to match their namespace in classes/KerrFairtex/StaffWidget/
- Move Widget classes to match their namespace in classes/KerrFairtex/Widget/
...
- Minor corrections to the Russian and Ukrainian translations in kerrfairtex.po & kerrfairtex.sql
...
- Add Administrator option to Visible To User Profiles in Resources.fnc.php, kerrfairtex.sql & kerrfairtex_mysql.sql
- Create Student Account: Force Default School in index.php, Configuration.php, Student.php, General_Info.inc.php, kerrfairtex.sql & kerrfairtex_mysql.sql
- SQL add csp_reports table in kerrfairtex.sql & kerrfairtex_mysql.sql
- Add Content Security Policy plugin in plugins/Content_Security_Policy/, kerrfairtex.sql & kerrfairtex_mysql.sql
...
- Update French & Spanish translations in kerrfairtex.po
...
- Change User-Agent to "KerrFairtex/1.0; +https://www.kerrfairtex.org/" in curl.php
...
- Default School Year: 2025 (2025-2026) in config.inc.sample.php, kerrfairtex.sql & kerrfairtex_mysql.sql

Changes in 12.3
---------------
- Multilingual course title: use ParseMLField(), program wide
- Multilingual course title: SQL change title column type from varchar(100) to text in Update.fnc.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
- Security: Cache killer: use file last modified time hash instead of KerrFairtex version in Warehouse.php
...
- Fix PHP fatal error Unknown format specifier "," in Greek translation in locale/el_GR.utf8/kerrfairtex.po
...
Changes in 12.2.1
-----------------
- PostgreSQL on cPanel fix ERROR: must be owner of language plpgsql in kerrfairtex.sql & Update.fnc.php
- PostgreSQL create plpgsql extension if not exists in kerrfairtex.sql
...
- Update French & Spanish translations in kerrfairtex.po
- Security: move KerrFairtex version from Login screen to Portal in index.php & Portal.php
...
- SQL remove deprecated columns in kerrfairtex.sql & kerrfairtex_mysql.sql
- Remove php.ini safe_mode check, deprecated since PHP 5.3 in Portal.php
- Send KerrFairtex version in Addon.fnc.php
...
- PostgreSQL remove deprecated create_language_plpgsql() in kerrfairtex.sql
- SQL N/A grade (empty GPA value) does not affect GPA in kerrfairtex.sql, kerrfairtex_mysql.sql & Update.fnc.php
- CSS themes small fixes + Reduce multiple select2 font size in stylesheet.css & colors.css
- SQL fix Breakoff percentages for Main grading scale in kerrfairtex_fr.sql & kerrfairtex_es.sql
...
Changes in 12.1
---------------
- MySQL set CREATED_AT on INSERT in kerrfairtex_mysql.sql
...
- SQL Add Admin Delete Permission to profile_exceptions & staff_exceptions tables in Update.fnc.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
Changes in 11.8
---------------
- SQL performance: reduce staff table row size (was 3.8KB) & remove HOMEROOM column in Rollover.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
- Update default school year to 2024 in config.inc.sample.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
Changes in 11.5
---------------
- Moodle plugin: Add REST API protocol in plugins/Moodle/, kerrfairtex.sql & kerrfairtex_mysql.sql
...
Changes in 11.4.4
-----------------
- Fix SQL transcript_grades view for History Marking Periods of existing school years in kerrfairtex.sql, kerrfairtex_mysql.sql & Update.fnc.php
...
- PostgreSQL fix limit set_updated_at_triggers() to current schema in kerrfairtex.sql
- SQL add Comment to every grade of the Main scale in kerrfairtex.sql & kerrfairtex_mysql.sql
...
- Add "Report a bug" link to Resources in kerrfairtex.sql, kerrfairtex_mysql.sql, kerrfairtex_es.sql & kerrfairtex_fr.sql
...
- Fix regression since 4.7 SQL set_class_rank_mp() Class Rank calculation when various school years in kerrfairtex.sql, kerrfairtex_mysql.sql & Update.fnc.php
...
- SQL add NOT NULL for student_medical type, student_medical_alerts title & student_medical_visits school_date columns in kerrfairtex.sql & kerrfairtex_mysql.sql
...
- Update French & Spanish translations in kerrfairtex.po & help.po
...
- SQL add FOREIGN KEY to transaction_id column in kerrfairtex.sql & kerrfairtex_mysql.sql
- SQL Add MENU_ITEM_ID column to food_service_transaction_items & food_service_staff_transaction_items tables in Update.fnc.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
- SQL Add CREATED_BY column to billing_fees & billing_payments tables in Update.fnc.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
- SQL new default is 0 for ATTENDANCE_FULL_DAY_MINUTES Config option in kerrfairtex.sql & kerrfairtex_mysql.sql
...
- FS transaction item ID references food_service_menu_items(menu_item_id) in ServeMenus.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
- SQL set min Credits to 0 & fix division by zero error in Courses.fnc.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
- SQL access_log: deprecate LOGIN_TIME column, use CREATED_AT instead in index.php, AccessLog.php, Dashboard.inc.php, kerrfairtex.sql & kerrfairtex_mysql.sql
- SQL portal_notes & portal_polls: deprecate PUBLISHED_DATE column, use CREATED_AT instead in PortalNotes.php, PortalPolls.php, Portal.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
- Increase default Password Strength from 1 to 2 in kerrfairtex.sql & kerrfairtex_mysql.sql
- PostgreSQL rename "rank" to "class_rank" in set_class_rank_mp() for consistency with MySQL in kerrfairtex.sql
...
- Move "Progress Reports" from Teacher Programs to Grades menu (admin) in Grades/Menu.php, ProgressReports.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
- SQL add accounting_categories table in kerrfairtex.sql & kerrfairtex_mysql.sql
- Add Categories program to Accounting module in Categories.php, Menu.php, kerrfairtex.sql & kerrfairtex_mysql.sql
...
- Translate Weight Assignments option to French & Spanish in kerrfairtex.pot & kerrfairtex.po
