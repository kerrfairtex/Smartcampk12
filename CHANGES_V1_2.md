...
- Add SELECT\_OPTIONS column to school_fields table in Update.fnc.php & kerrfairtex.sql
...
- Update database for Admin User Profile restriction in kerrfairtex.sql & Update.fnc.php
...
- Update database for Admin Schools restriction in kerrfairtex.sql & Update.fnc.php
...
please also upgrade the [Students Import](https://github.com/kerrfairtex/Students_Import) & [Reports](https://github.com/kerrfairtex/Reports) add-on modules.
...
- Gender & Ethnicity Student Fields not Required by default in kerrfairtex.sql
...
- Update Default School Year to 2016 in kerrfairtex.sql & config.inc.sample.php
...
- Place KerrFairtex version, disclaimer & copyright inside "About" toggle in index.php
...
- Add course_period_school_periods_id to course_period_school_periods table primary key in kerrfairtex.sql
...
- Create school_fields_seq Sequence in kerrfairtex.sql & Update.fnc.php
...
- Add STUDENTS_EMAIL_FIELD to config table in kerrfairtex.sql & Configuration.php
...
- Update official site URLs: HTTPS on kerrfairtex.org
...
- Send emails from programname instead of kerrfairtex in SendEmail.fnc.php
...
Changes in 2.8.15
-----------------
- 2015-2016 School Year update in kerrfairtex.sql & config.inc.sample.php
...
Changes in 2.8.12
-----------------
- Fix #102 error language "plpgsql" does not exist in kerrfairtex.sql
...
Changes in 2.8.7
----------------
- Fix #101 cookie domain if KerrFairtex installed at server www root in Warehouse.php
...
- Fix SQL error relation "custom" does not exist in kerrfairtex.sql
...
- Remove table CUSTOM in kerrfairtex.sql
...
- send email from kerrfairtex@[domain] in NotifyParents.php
...
- Allow students to change their password by default in kerrfairtex.sql
...
- history grades in Transripts in Transcripts.php & kerrfairtex.sql
...
- Execute the SQL commands, see https://gist.github.com/kerrfairtex/b451c8006d5e1978fb0d
...
- Bigger config values capacity to accept serialized variables in kerrfairtex.sql
...
- Send email from kerrfairtex@[site_domain] in SendEmail.fnc.php
...
- Execute the SQL commands, see https://gist.github.com/kerrfairtex/eee136a8431b704646dc
...
- Note: all the modules coming with KerrFairtex will be activated
...
Upgrade from 2.5.x
------------------
- Execute the SQL commands to add the accounting module & the food service options, see https://gist.github.com/kerrfairtex/8cd6c3625a68628674a8
- Add the Accounting module to the config.inc.php file, see https://github.com/kerrfairtex/kerrfairtex/blob/mobile/config.inc.sample.php#L40

Note for developers
-------------------
- The default program to be loaded when a module is opened is not defined in the Search.php file anymore. Please update your custom modules' Menu.php file by adding the "default" entry, following this example https://github.com/kerrfairtex/kerrfairtex/blob/mobile/modules/Attendance/Menu.php#L3
...
Upgrade from 2.x
----------------
- Execute the SQL commands to add default points to the gradebook assignments, see https://gist.github.com/kerrfairtex/87c12769735311bee428

Changes in 2.4.1
----------------
- Update 2014 SQL: add Resources table in kerrfairtex2014.sql
...
Upgrade from 2.x
----------------
- Execute the SQL commands to install Resources, see https://gist.github.com/kerrfairtex/11379623
...
- kerrfairtex.sql for 2014: kerrfairtex2014.sql
...
- Update french & spanish translations
- SQL bugfix: remove search + system_field in custom_fields INSERTS in kerrfairtex.sql
...
- SQL bugfix KerrFairtex ID assigned not numeric error
- Add School Fields:
...
Upgrade from 2.x
----------------
- Execute the SQL commands to install School Fields, see https://gist.github.com/kerrfairtex/9118591

Changes in 2.1.1
----------------
- Unbind ajaxForm in Successful Install form
- Bugfix false low food service balance alert
- Link example parent to example student in kerrfairtex.sql
...
Upgrade from 1.3x
-----------------
- execute those 3 SQL statements to fix KerrFairtex database:
...
- removed staff_exceptions table data in kerrfairtex.sql
- bugfix: SQL bug 'NULL' instead of NULL in InputFinalGrades.php
- relate users to Default School in kerrfairtex.sql
- added translations


Changes in 1.1
---------------
- added link to kerrfairtex.org in index.php
...
- added gettext on every string in KerrFairtex
...
- bugfix: ListOutput.fnc.php bug ngettext when the plural form is not registered as this in the kerrfairtex.po file
