...
Changes in 4.9.8
----------------
- Fix SQL error set KerrFairtex ID maxlength to 9 in General_Info.inc.php & Student.php
...
- program_config table: Add Allow Teachers to edit gradebook grades for past quarters option in Update.fnc.php, kerrfairtex.sql & Configuration.php, sponsored by Santa Cecilia school
...
Changes in 4.8.3
----------------
- Add Install KerrFairtex database script in InstallDatabase.php
...
- Move Studies Certificate title and Signatures HTML to Template in Transcripts.php, kerrfairtex.sql, kerrfairtex_es.sql & kerrfairtex_fr.sql
...
- Update default school year to 2019 in kerrfairtex.sql & config.inc.sample.php
...
- Change Pull-Down (Auto & Export), Select Multiple from Options, Text, Long Text columns type to text in Update.fnc.php & Fields.fnc.php & kerrfairtex.sql
...
- Remove GPA / MP List program in GPAMPList.php, Menu.php & kerrfairtex.sql
- Add CLASS_RANK_CALCULATE_MPS to config table in Update.fnc.php & kerrfairtex.sql
...
- SQL performance: rewrite set_class_rank_mp() function in kerrfairtex.sql & Update.fnc.php
- SQL remove calc_cum_gpa_mp() function & include it in t_update_mp_stats() trigger in kerrfairtex.sql & Update.fnc.php
- Remove Calculate GPA program in CalcGPA.php, Menu.php, Help_en.php & kerrfairtex.sql
...
- SQL eligibility_activities table: Add COMMENT column in Update.fnc.php & kerrfairtex.sql
...
- gradebook_assignment_types table: Add CREATED_MP column in kerrfairtex.sql & Update.fnc.php
...
- Spanish translation: "bimestre" => "trimestre" in es_ES.utf8/kerrfairtex.po & help.po
...
- gradebook_assignments table: Add FILE column in kerrfairtex.sql & Update.fnc.php
- gradebook_assignments table: Change DESCRIPTION column type to text in kerrfairtex.sql & Update.fnc.php
...
- Add PASSWORD_STRENGTH to config table in Update.fnc.php & kerrfairtex.sql
...
- Add DESCRIPTION column to courses table + when rolling Courses in kerrfairtex.sql & Rollover.php
...
- SQL config table: Change config_value column type to text in kerrfairtex.sql & Update.fnc.php
...
- Remove Honor Roll by Subject program in HonorRollSubject.php, Menu.php & kerrfairtex.sql
...
- Remove "Add a School" program in Schools.php, Menu.php, kerrfairtex.sql & Help_en.php
...
- Fix SQL error in calc_gpa_mp function on INSERT Final Grades for students with various enrollment records in kerrfairtex.sql & Update.fnc.php
...
- Translate database fields to Spanish or French in kerrfairtex_es.sql & kerrfairtex_fr.sql
...
- Fix #244: Add DISPLAY_NAME to config table for every school in Configuration.php, kerrfairtex.sql & Update.fnc.php, sponsored by Asian Hope
- Default school year is 2018 in kerrfairtex.sql & config.inc.sample.php
...
- Fix Error: KerrFairtex cannot connect to the PostgreSQL in diagnostic.php
...
- Gettext .pot file available in locale/en_US.utf8/LC_MESSAGES/kerrfairtex.pot
...
- #218 Add DISPLAY_NAME to config table in kerrfairtex.sql & Update.fnc.php
...
- Give teachers, parents & students access to Courses program in Scheduling/Menu.php & kerrfairtex.sql
...
- #199 Add FAILED_LOGIN_LIMIT Config option in kerrfairtex.sql & Update.fnc.php & Configuration.php
...
- Default school year is 2017 in kerrfairtex.sql & config.inc.sample.php
...
- Add kerrfairtex2017.sql for 2017 school year DB in kerrfairtex2017.sql
...
- Fix SQL error when entering (Unweighted) GPA Value > 99.99 in kerrfairtex.sql & Update.fnc.php
...
- Add link to KerrFairtex Forum to Resources in kerrfairtex.sql
...
- Add Marking Periods to parents & students in School_Setup/Menu.php & kerrfairtex.sql
- Add Access Log, thanks to @dpredster in AccessLog.php, index.php, Update.fnc.php & kerrfairtex.sql
