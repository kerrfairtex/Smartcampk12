...
Changes in 6.9
--------------
- SQL course_periods table: Add SECONDARY_TEACHER_ID column in Update.fnc.php & kerrfairtex.sql
...
- Translate "Secondary Teacher" strings to French & Spanish in kerrfairtex.po
- JS Select use this.value instead of this.options[selectedIndex].value, program wide
- SQL deprecate gradebook_grades column PERIOD_ID in Grades.php & kerrfairtex.sql
...
- Add Registration program for Administrators in Update.fnc.php, Custom/Menu.php & kerrfairtex.sql
...
- Translate new Registration program strings to French & Spanish in kerrfairtex.po
...
- Default School Year: 2020 in config.inc.sample.php & kerrfairtex.sql
- Add warning when Marking Period dates are not within Parent MP dates range in MarkingPeriods.php & kerrfairtex.po
...
- Translate "Your changes were saved." to French & Spanish in kerrfairtex.po
...
- Translate "Upload" & "Cannot open file." to French & Spanish in kerrfairtex.po
...
- SQL add Donate link in kerrfairtex.sql, kerrfairtex_es.sql & kerrfairtex_fr.sql
...
- SQL add CREATE_STUDENT_ACCOUNT_DEFAULT_SCHOOL to config table in kerrfairtex.sql & Update.fnc.php
- Add Create Student Account Default School option in Configuration.php, index.php & Help_en.php
- Translate "Default School" & help to French & Spanish in kerrfairtex.po & help.po
...
- Translate "Student Account" to French & Spanish in kerrfairtex.po
...
- Moodle remove ROSARIO_STUDENTS_EMAIL_FIELD_ID config, use STUDENTS_EMAIL_FIELD in StudentsUsersInfo.fnc.php, Other_Info.inc.php, Moodle/config.inc.php, Moodle/getconfig.inc.php & kerrfairtex.sql
...
- SQL Fix School Base Grading Scale for Historical Grades in transcript_grades view in Update.fnc.php & kerrfairtex.sql
...
- SQL Rename PHONE column to CUSTOM_200000001 in staff table in kerrfairtex.sql & Update.fnc.php
- SQL Add Email & Phone to Staff Fields in kerrfairtex.sql, kerrfairtex_es.sql, kerrfairtex_fr.sql & Update.fnc.php
...
- Add CREATE_STUDENT_ACCOUNT_AUTOMATIC_ACTIVATION to config table in Update.fnc.php & kerrfairtex.sql
...
- Move REMOVE_ACCESS_USERNAME_PREFIX_ADD from program_config (per school) to config (all schools, 0) in RemoveAccess.php, kerrfairtex.sql & Update.fnc.php
...
- Add GRADEBOOK_CONFIG_ADMIN_OVERRIDE config option in kerrfairtex.sql
...
- SQL Change short_name column type to character varying(3). Now allows French elementary grade levels in GradeLevels.php, Update.fnc.php, kerrfairtex.sql & kerrfairtex_fr.sql
...
Changes in 5.7
--------------
- SQL address table: city & mail_city column type to text in kerrfairtex.sql, Address.inc.php & Update.fnc.php
- SQL address table: state & mail_state column type to character varying(50) in kerrfairtex.sql, Address.inc.php & Update.fnc.php
...
- SQL report_card_grades table: Change title column type to character varying(5) in kerrfairtex.sql, Update.fnc.php & ReportCardGrades.php
...
Changes in 5.4.3
----------------
- SQL fix set_updated_at trigger PostgreSQL 8.4 compatible in kerrfairtex.sql, Update.fnc.php

Changes in 5.4.2
----------------
- Fix "Strengthen allow edit logic for teachers" when TeacherPrograms (admin) in InputFinalGrades.php
- SQL Set 50 minutes length for School Periods in kerrfairtex.sql
- HTML Short Name input is required in GradeLevels.php
- Fix SQL error in calc_gpa_mp function on INSERT Final Grades: column short_name does not exist, PostgreSQL 8.4 in kerrfairtex.sql & Update.fnc.php
...
- Add Progress Reports program for admin (Teacher Programs), student & parent in ProgressReports.php, Menu.php & kerrfairtex.sql
...
- French & Spanish translation review: correct plural forms & typos in kerrfairtex.po
...
- Add Bulgarian translation in bg_BG.utf8/LC_MESSAGES/kerrfairtex.po, thanks to Martin Krastev
...
- Translate "Remove Access" custom program to "Bloquer l'accès" in French in kerrfairtex.po & help.po
- Add FORCE_PASSWORD_CHANGE_ON_FIRST_LOGIN to config table in kerrfairtex.sql & Update.fnc.php
...
- Add help & translations for Password Strength & Force Password Change on First Login in Help_en.php, help.po & kerrfairtex.po
...
- Use text type instead of character varying in kerrfairtex.sql
- Add NOT NULL constraint to TITLE columns in kerrfairtex.sql & Update.fnc.php
...
- Rename default Resource links in kerrfairtex.sql, kerrfairtex_es.sql & kerrfairtex_fr.sql
...
- SQL use integer type for TABLE_NAME column in kerrfairtex.sql
...
- SQL course_periods table: Change title column type to text in Update.fnc.php & kerrfairtex.sql
...
Changes in 5.0
--------------
- Use integer column type instead of numeric in kerrfairtex.sql
- SQL Remove DISCIPLINE_CATEGORIES table in kerrfairtex.sql & Rollover.php
- SQL Move PRIMARY KEY & UNIQUE to CREATE TABLE in kerrfairtex.sql
- SQL Remove UNIQUE & INDEX constraints for PRIMARY KEY in kerrfairtex.sql
- SQL Add CREATED_AT & UPDATED_AT columns to every table in kerrfairtex.sql
- SQL Add set_updated_at() function & set_updated_at trigger in kerrfairtex.sql
- SQL use serial for IDs in kerrfairtex.sql
- SQL remove & rename existing sequences in kerrfairtex.sql & Update.fnc.php
...
- SQL Add foreign keys: student_id, staff_id, school_id+syear, marking_period_id, course_period_id, course_id in kerrfairtex.sql & Update.fnc.php
- SQL create tables & insert data in right order in kerrfairtex.sql
- SQL Use NEXTVAL() on data insert in kerrfairtex.sql & kerrfairtex_fr.sql
