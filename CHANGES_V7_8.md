...
- Add French & Spanish translation for "Icon successfully uploaded." in kerrfairtex.po
...
- Fix typo in English string, update translations in Rollover.php & kerrfairtex.mo
...
- Fix SQL transcript_grades view, grades were duplicated for each school year in kerrfairtex.sql & Update.fnc.php
...
- Use KerrFairtex\Widgets in Widgets.fnc.php
...
- Use KerrFairtex\StaffWidgets in StaffWidgets.fnc.php
...
- SQL add PRIMARY KEY to staff_exceptions table in kerrfairtex.sql
- SQL profile_exceptions & staff_exceptions tables: Add Admin Student Payments Delete restriction in Update.fnc.php & kerrfairtex.sql
...
Changes in 8.4
--------------
- SQL gradebook_grades table: Change comment column type to text in Update.fnc.php & kerrfairtex.sql
...
- SQL accounting_incomes table: Add FILE_ATTACHED column in Update.fnc.php & kerrfairtex.sql
...
- SQL accounting_payments table: Add FILE_ATTACHED column in Update.fnc.php & kerrfairtex.sql
- SQL billing_payments table: Add FILE_ATTACHED column in Update.fnc.php & kerrfairtex.sql
- Add help note for student deletion & translate in Help_en.php & help.po
- Add KerrFairtex URL to image path in MarkDownHTML.fnc.php
...
- SQL accounting_salaries table: Add FILE_ATTACHED column in Update.fnc.php & kerrfairtex.sql
- Add File Attached to Salaries in Salaries.php & Accounting/functions.inc.php
- SQL billing_fees table: Add FILE_ATTACHED column in Update.fnc.php & kerrfairtex.sql
...
- Default theme is now FlatSIS in kerrfairtex.sql
...
- Remove Daily Totals program from Student Billing & Accounting menus in Menu.php & kerrfairtex.sql
...
- Remove Absence Summary program from Attendance menu in Menu.php, Help_en.php & kerrfairtex.sql
...
Changes in 7.9
--------------
- Update default School Year to 2021 in kerrfairtex.sql & config.inc.sample.php
...
- SQL fix Report Card Grades insert in kerrfairtex_fr.sql
...
- French translation: replace "Effacer" with "Supprimer" in kerrfairtex.po & help.po
...
- Fix 'School' translation when using MoTranslator in Schedule.inc.php & kerrfairtex.po
...
- Merge Schedule Report & Master Schedule Report in Menu.php, MasterScheduleReport.php, ScheduleReport.php & kerrfairtex.sql
- Add Students column to report in RequestsReport.php
- Merge Requests Report & Unfilled Requests in Menu.php, RequestsReport.php, UnfilledRequests.php, Scheduler.php, Help_en.php & kerrfairtex.sql
- Merge Average Daily Attendance & Average Attendance by Day in Menu.php, Percent.php, Help_en.php, help.po & kerrfairtex.sql
...
- SQL no access to Custom "My Report" program for admin by default in kerrfairtex.sql
