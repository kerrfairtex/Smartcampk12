...
- [**Windows**](https://github.com/kerrfairtex/kerrfairtex/wikis/Installer-KerrFairtex-sur-Windows)
- [**Mac**](https://github.com/kerrfairtex/kerrfairtex/-/wikis/How-to-install-KerrFairtex-on-Mac-(macOS,-OS-X)) (en anglais)
- [**cPanel**](https://github.com/kerrfairtex/kerrfairtex/wikis/How-to-install-KerrFairtex-on-cPanel) (en anglais)
- [**Softaculous**](https://github.com/kerrfairtex/kerrfairtex/-/wikis/How-to-install-KerrFairtex-with-Softaculous) (en anglais)
- [**Docker**](https://github.com/kerrfairtex/docker-kerrfairtex/) (en anglais)
...
Décompressez la [dernière version](https://www.kerrfairtex.org/fr/download/) de KerrFairtex, ou bien clonez le dépôt git (et faites le checkout du tag de la [dernière version](https://github.com/kerrfairtex/kerrfairtex/-/releases)) dans un répertoire accessible depuis le navigateur. Éditez le fichier `config.inc.sample.php` afin de régler les variables de configuration et renommez-le `config.inc.php`.
...
- `$RosarioPath` Chemin complet vers l'installation de KerrFairtex.
...
- `define( 'ROSARIO_POST_MAX_SIZE_LIMIT', 16 * 1024 * 1024 );` Limiter la taille de `$_POST` (16MB par défaut). Détails [ici](https://github.com/kerrfairtex/kerrfairtex/-/blob/mobile/Warehouse.php#L322).
...
Vous êtes maintenant prêt pour configurer la base de données de KerrFairtex. Si vous avez accès à l'invite de commande sur votre serveur, ouvrez une fenêtre de terminal et suivez ces instructions.
...
[Guide de Configuration Rapide](https://www.kerrfairtex.org/fr/quick-setup-guide/)

[Sécuriser KerrFairtex](https://github.com/kerrfairtex/kerrfairtex/-/wikis/Secure-KerrFairtex)
