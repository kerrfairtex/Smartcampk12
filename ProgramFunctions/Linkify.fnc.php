 ...
 *
 * @deprecated since KerrFairtex 13.0 Use your own function instead.
 *
...
{
	trigger_error(
		'Linkify() function is deprecated since KerrFairtex 13.0. Please use your own function instead.',
		E_USER_DEPRECATED
	);
