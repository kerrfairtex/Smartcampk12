 ...
 * @since 8.3   Add KerrFairtex URL to image path.
 * @since 12.7 Autoload classes (PSR-4)
 *
 * @static object $security
 *
 ...
 * @param  bool   $add_url_to_image_path Add KerrFairtex URL to image path. Useful when HTML used in email to display remote images.
 *
 * @return string Sanitized input with HTML encoded single quotes
 */
