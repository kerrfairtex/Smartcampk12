...
function SendNotificationCreateStudentAccount( $student_id, $to = '' )
{
	...
	return (new KerrFairtex\Functions\Email)->send( $to, _( 'Create Student Account' ), $message );
}
...
function SendNotificationCreateUserAccount( $staff_id, $to = '' )
{
	...
	return (new KerrFairtex\Functions\Email)->send( $to, _( 'Create User Account' ), $message );
}
...
function SendNotificationNewAdministrator( $staff_id, $to = '' )
{
	...
	return (new KerrFairtex\Functions\Email)->send( $to, _( 'New Administrator Account' ), $message );
}

/**
 * Send Activate Student Account notification
 * Do not send notification if password not set.
 * Do not send notification if KerrFairtex installed on localhost (Windows typically).
 *
 * @since 5.9
 *
 * @param int    $student_id Student ID.
 ...
 * Do not send notification if password not set.
 * Send notification even if KerrFairtex installed on localhost (Windows typically)
...
function SendNotificationNewStudentAccount( $student_id, $to = '', $password = '' )
{
	...
	return (new KerrFairtex\Functions\Email)->send( $to, _( 'Student Account' ), $message );
}
...
function SendNotificationNewUserAccount( $staff_id, $to = '', $password = '' )
{
	...
	return (new KerrFairtex\Functions\Email)->send( $to, _( 'User Account' ), $message );
}
