...
function Update()
{
	 ...
	 */
	if ( version_compare( '12.9.2', ROSARIO_VERSION, '<' ) )
	{
		return false;
	}
 ...
 *
 * 1. Update transcript_grades view
 * Fix SQL transcript_grades view for Historical Marking Periods of existing school years
 *
 * Local function
 *
 * @since 11.4.4
