 ...
 *
 * 1. SQL set default nextval (auto increment) for KerrFairtex version < 5.0 on install,
 * serial column (auto increment was implemented in KerrFairtex 5.0)
...
function _update921()
{
	...
	/**
	 * 1. Set default nextval (auto increment) for KerrFairtex version < 5.0 on install,
	 * serial column (auto increment was implemented in KerrFairtex 5.0)
	 */
