...
function SideMarkingPeriodSelect()
{
	...
	<select name="mp" id="mp" autocomplete="off" class="onchange-ajax-post-form">
	<?php if ( count( $mp_RET ) ) :
	...
	<form action="Side.php?sidefunc=update" method="POST" target="menu-top">
		...
		if ( User( 'PROFILE' ) === 'admin'
			...
			<span class="br-after">
				...
				<select name="school" id="school" autocomplete="off" class="onchange-ajax-post-form">
		...
		if ( User( 'PROFILE' ) === 'parent' ) :
			...
			<span class="br-after">
				...
				<select name="student_id" id="student_id" autocomplete="off" class="onchange-ajax-post-form">
		...
		<span class="br-after">
			...
			<select name="syear" id="syear" autocomplete="off" class="onchange-ajax-post-form">
...
<?php // Generate Menu.
	...
	foreach ( $_ROSARIO['Menu'] as $menu_i => $modcat_menu ) :
		...
		$active_class = (isset($_REQUEST['modname']) && strpos($_REQUEST['modname'], $menu_i . '/') === 0) ? ' active' : ''; ?>
		<li class="menu-module <?php echo $modcat_class . $active_class; ?>">
			<a href="<?php echo URLEscape( 'Modules.php?modname=' . $modcat_menu['default'] ); ?>" class="menu-top">
				...
				>
				<?php
				// Inline SVG icons for core modules
				$icons = [
					'School_Setup' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',
					...
					'Discipline' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',
					'Accounting' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',
					'Student_Billing' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>',
					'Food_Service' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>',
