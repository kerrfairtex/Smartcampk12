...
## KerrFairtex Student Information System
...
- [Reports](https://www.kerrfairtex.org/modules/reports/) module 12.1+ (May 2026)
- [NFC/QR Actions](https://www.kerrfairtex.org/modules/nfc-qr-actions/) module 2.6+ (June 2026)
- [Parent Agreement](https://github.com/kerrfairtex/Parent_Agreement/) plugin 10.5+ (May 2026)

Add Italian translation, thanks to Stefania Binda

[Chrome To PDF](https://github.com/kerrfairtex/Chrome_To_PDF) plugin, sponsored by École Saint-Martin, France

[Student Import Premium](https://www.kerrfairtex.org/modules/students-import/)
- Delete existing students before import (optional, only if all students can be deleted)

[Billing Elements](https://www.kerrfairtex.org/modules/billing-elements/)
...
[Backup](https://github.com/kerrfairtex/Backup) module (now provides the _Database Backup_ program)
...
Please update the [CoolAdmin](https://www.kerrfairtex.org/themes/cooladmin/) theme to version 3+

PHP8.5 compatibility

[Unsaved Changes Warning](https://github.com/kerrfairtex/Unsaved_Changes_Warning) plugin, sponsored by International Philippine School in Jeddah
...
[Previous Next Student](https://github.com/kerrfairtex/Previous_Next_Student) plugin, sponsored by AT group, Slovenia

[Timetable Import](https://www.kerrfairtex.org/modules/timetable-import/)
- Relate teacher based on KerrFairtex ID
...
- [Assignment Max Points](https://github.com/kerrfairtex/Assignment_Max_Points/) 1.5+ (July 2025)
...
[CoolAdmin](https://www.kerrfairtex.org/themes/cooladmin/) theme, sponsored by International Philippine School in Jeddah

[Hostel Premium](https://www.kerrfairtex.org/modules/hostel/)
...
- [TinyMCE Record Audio Video](https://www.kerrfairtex.org/plugins/tinymce-record-audio-video/) plugin version 10.4+ (April, 2025)
...
[Meeting](https://www.kerrfairtex.org/modules/meeting/) & Meeting Premium modules, sponsored by English National Program, France
...
[PDF Header Footer Premium](https://www.kerrfairtex.org/plugins/pdf-header-footer/) plugin
...
[Class Diary Premium](https://www.kerrfairtex.org/modules/class-diary/) module
...
Security:
- Move KerrFairtex version number from login screen to Portal (admin only)
...
Grades
- Grading Scales: "N/A" grade (empty GPA value & Breakoff) is now a [grade that does not affect GPA](https://www.kerrfairtex.org/forum/d/1238-is-there-a-way-to-add-a-grade-that-does-not-affect-the-gpa)

[Microsoft Social Login](https://www.kerrfairtex.org/plugins/microsoft-social-login/) plugin
...
[Entry and Exit](https://www.kerrfairtex.org/modules/entry-exit/) module

[NFC/QR Actions](https://www.kerrfairtex.org/modules/nfc-qr-actions/) module

[TTHotel Smart Locks](https://www.kerrfairtex.org/modules/tthotel-smart-locks/) module

The above modules are sponsored by AT group, Slovenia

[Email Parents](https://www.kerrfairtex.org/modules/email-parents/) module
- Send Days Absent (for a specific period), sponsored by Paris'Com Sup, France

[Certificate](https://www.kerrfairtex.org/modules/certificate/) module
- Add background image / watermark, sponsored by Paris'Com Sup, France

[Messaging Premium](https://www.kerrfairtex.org/modules/messaging/) module
- Notify me by email when I receive a message, sponsored by Paris'Com Sup, France

[Audit](https://github.com/kerrfairtex/Audit) module
...
**Breaking change**, please upgrade the following add-ons:
- [Email SMTP](https://www.kerrfairtex.org/plugins/email-smtp/) plugin version 10.4+ (March, 2024)
- [Email Log](https://github.com/kerrfairtex/Email_Log) module version 1.2+ (March, 2024)
- [Reports](https://www.kerrfairtex.org/modules/reports/) module version 10.6+ (May, 2024)
- [Human Resources](https://www.kerrfairtex.org/modules/human-resources/) module version 10.2+ (August, 2023)
- [Calendar Schedule View](https://www.kerrfairtex.org/plugins/calendar-schedule-view/) plugin version 10.2+ (July, 2024)
- [Quiz](https://www.kerrfairtex.org/modules/quiz/) module version 10.7+ (December, 2024)
- [Assignment Max Points](https://github.com/kerrfairtex/Assignment_Max_Points/) plugin version 1.2+ (December, 2024)
...
Those files are now uploaded under a subdirectory of `assets/Fileuploads/`. See the [`$FileUploadsPath`](https://github.com/kerrfairtex/kerrfairtex/-/blob/mobile/INSTALL.md#optional-variables) config variable.

Add-on installations statistics (on first activation). To disable, use the [`ROSARIO_DISABLE_USAGE_STATISTICS`](https://github.com/kerrfairtex/kerrfairtex/-/blob/mobile/INSTALL.md#optional-variables) config constant.

[New translations](locale/REFERENCE.md) (99% completed, includes help), thanks to Georgios Katakalos
- Greek (Greece)
- Turkish (Turkey)

[Stripe Registration](https://www.kerrfairtex.org/plugins/stripe-registration/) plugin, sponsored by English National Program, France

[Library Premium](https://www.kerrfairtex.org/modules/library/)
...
[Staff and Parents Import](https://www.kerrfairtex.org/modules/staff-parents-import/) module
- Assign users to a specific school, sponsored by LGBTQInnos, USA

[Templates](https://www.kerrfairtex.org/plugins/templates) plugin
- Integrates with the [Messaging Premium](https://www.kerrfairtex.org/modules/messaging/) module, sponsored by @Hirama666
...
School
- Rollover: update the default school year (if the `config.inc.php` file can be edited). [Rollover Guide PDF](https://www.kerrfairtex.org/documentation/) update
...
[Student Billing Premium](https://www.kerrfairtex.org/modules/student-billing-premium/): link your [Stripe](https://stripe.com/) account and accept payments. Stripe is [available in 46 countries](https://stripe.com/global).

[Custom Menu](https://github.com/kerrfairtex/Custom_Menu/) plugin sponsored by AT group, Slovenia

[Instant List Search and Sorting](https://github.com/kerrfairtex/Instant_List_Search_Sorting/) plugin sponsored by AT group, Slovenia
...
[Email Log](https://www.kerrfairtex.org/modules/email-log) module

[PDF Archive](https://github.com/kerrfairtex/PDF_Archive) module

[Append Custom Field to Grade Level](https://github.com/kerrfairtex/Append_Custom_Field_to_Grade_Level) plugin
...
[Food Service Premium](https://www.kerrfairtex.org/modules/food-service-premium/) module, sponsored by AT group, Slovenia

[SMS Premium](https://www.kerrfairtex.org/modules/sms/)
...
[Absent for the Day on First Absence](https://github.com/kerrfairtex/Absent_for_the_Day_on_First_Absence) plugin, sponsored by Paris'Com Sup, France
...
[Lesson Plan](https://www.kerrfairtex.org/modules/lesson-plan/) module, sponsored by Rousseau International, Cameroon

[Class Diary Premium](https://www.kerrfairtex.org/modules/class-diary/#premium-module)
...
[Grades Import](https://www.kerrfairtex.org/modules/grades-import/)
- Import Final Grades, sponsored by Univers Frère Raphaël, Haiti

[Students Import Premium](https://www.kerrfairtex.org/modules/students-import/#premium-module)
...
[Assignment Max Points](https://github.com/kerrfairtex/Assignment_Max_Points) plugin
...
KerrFairtex can now be installed with [Softaculous](https://github.com/kerrfairtex/kerrfairtex/-/wikis/How-to-install-KerrFairtex-with-Softaculous)
...
[Student Billing Premium](https://www.kerrfairtex.org/modules/student-billing-premium/)
...
[SMS Premium](https://www.kerrfairtex.org/modules/sms/): new gateway, WhatsApp Cloud API, sponsored by EspaceHitech.mg


New in 10.4
-----------

[Hostel](https://www.kerrfairtex.org/modules/hostel/) module
...
[Installation tutorial for Mac (macOS, OS X)](https://github.com/kerrfairtex/kerrfairtex/-/wikis/How-to-install-KerrFairtex-on-Mac-(macOS,-OS-X))
...
Know more about KerrFairtex version 10 and MySQL support in this [blog post](https://www.kerrfairtex.org/blog/#mysql-support).
...
[Quiz Premium](https://www.kerrfairtex.org/modules/quiz/)
...
[Email Students](https://www.kerrfairtex.org/modules/email-students/)
...
[Email Parents](https://www.kerrfairtex.org/modules/email-parents/)
- Automatically send (child's) Birthday notifications
- Automatically send Payment reminders (outstanding fees), X days before or after Due date
Sponsored by Rousseau International school

[SMS Premium](https://www.kerrfairtex.org/modules/sms/#premium-module)
...
[Quiz Premium](https://www.kerrfairtex.org/modules/quiz/#premium-module) module, sponsored by Dzung Do
...
[Class Diary](https://www.kerrfairtex.org/modules/class-diary/) module


New in 7.7
----------

[Google Social Login](https://www.kerrfairtex.org/plugins/google-social-login/) plugin, sponsored by Santa Cecilia school
...
[Automatic Attendance](https://www.kerrfairtex.org/plugins/automatic-attendance/) plugin, sponsored by Paris'Com Sup
...
[Certificate](https://www.kerrfairtex.org/modules/certificate/) module, sponsored by Paris'Com Sup

[Email](https://www.kerrfairtex.org/modules/email/) module:
...
[Staff Absences](https://www.kerrfairtex.org/modules/staff-absences/) module, sponsored by English National Program
...
[Student Billing Premium](https://www.kerrfairtex.org/modules/student-billing-premium/) module:
...
[SMS Premium](https://www.kerrfairtex.org/modules/sms/#premium-module) module:
...
School
- Configuration: Add-on zip upload (check [INSTALL.md](https://github.com/kerrfairtex/kerrfairtex/-/blob/mobile/INSTALL.md#optional-variables) to disable).

[Students Import Premium](https://www.kerrfairtex.org/modules/students-import/#premium-module) module:
...
[Jitsi Meet](https://www.kerrfairtex.org/modules/jitsi-meet/) module, sponsored by Santa Cecilia school.


New in 6.1
----------

[Students Import](https://www.kerrfairtex.org/modules/students-import/) module:
...
[TinyMCE Record Audio Video](https://www.kerrfairtex.org/plugins/tinymce-record-audio-video/) plugin
...
[Paypal Registration](https://www.kerrfairtex.org/plugins/paypal-registration/) plugin
...
- [Staff and Parents Import](https://www.kerrfairtex.org/modules/staff-parents-import/) module to version 1.3
- [SMS](https://www.kerrfairtex.org/modules/sms/) + Premium modules to version 1.5
- [Public Pages Premium](https://www.kerrfairtex.org/plugins/public-pages/) plugin to version 1.5
...
[iCalendar](https://www.kerrfairtex.org/plugins/icalendar/) plugin
...
[Grades Import](https://www.kerrfairtex.org/modules/grades-import/) module, sponsored by Instituto Japon.

[Iomad](https://www.kerrfairtex.org/plugins/iomad/) plugin (multi-tenancy Moodle), sponsored by LearnersPlatform
...
[Public Pages Premium](https://www.kerrfairtex.org/plugins/public-pages/)
...
[Semester Rollover](https://github.com/kerrfairtex/Semester_Rollover/) module, sponsored by Instituto Japon.

[Billing Elements](https://www.kerrfairtex.org/modules/billing-elements/) module, sponsored by English National Program.


New in 5.6
----------

[SMS](https://www.kerrfairtex.org/modules/sms/) module.

[Library Premium](https://www.kerrfairtex.org/modules/library/) module.

[TinyMCE Formula](https://www.kerrfairtex.org/plugins/tinymce-formula/) plugin.

[Attendance Excel Sheet](https://github.com/kerrfairtex/Attendance_Excel_Sheet) module, sponsored by Tintamail.
...
[Grading Scale Generation](https://github.com/kerrfairtex/Grading_Scale_Generation/) plugin, sponsored by Signo Digital.
...
[LDAP](https://www.kerrfairtex.org/plugins/ldap/) plugin

[Force Password Change](https://github.com/kerrfairtex/Force_Password_Change/) plugin, sponsored by Santa Cecilia school.

[Convert Names To Titlecase](https://github.com/kerrfairtex/Convert_Names_To_Titlecase/) plugin
...
[Relatives](https://www.kerrfairtex.org/plugins/relatives/) plugin, sponsored by Asian Hope

[REST API](https://github.com/kerrfairtex/REST_API/) plugin
...
[Setup Assistant](https://www.kerrfairtex.org/plugins/setup-assistant/) plugin
...
[Timetable Import](https://www.kerrfairtex.org/modules/timetable-import/) module

[Discipline Score](https://www.kerrfairtex.org/plugins/discipline-score/) plugin
...
[Calendar Schedule View](https://www.kerrfairtex.org/plugins/calendar-schedule-view/) plugin, sponsored by Revamp Consulting.
...
[Public Pages](https://www.kerrfairtex.org/plugins/public-pages/) plugin

[Email Alerts](https://www.kerrfairtex.org/modules/email-alerts/) module, sponsored by Santa Cecilia school.
...
[Library](https://www.kerrfairtex.org/modules/library/) module
...
[Email Students](https://www.kerrfairtex.org/modules/email-students/) module
...
[Quiz](https://www.kerrfairtex.org/modules/quiz/) module
...
[Email SMTP](https://www.kerrfairtex.org/plugins/email-smtp/) plugin
...
[Staff and Parents Import](https://www.kerrfairtex.org/modules/staff-parents-import/) module, sponsored by @abogadeer
...
New [PDF Header Footer](https://www.kerrfairtex.org/plugins/pdf-header-footer) plugin
...
[MarkDown](https://github.com/kerrfairtex/kerrfairtex/wikis/Markdown-Cheatsheet) support for Large text fields
...
Open KerrFairtex links in new tab
...
Translation
- Every string in KerrFairtex now translatable
