 ...
 * Security class
 *
 * Note: adapted for KerrFairtex.
 * - Renamed to Security.
 * - CSRF code removed.
 * - Constructor $charset param optional.
 * - Allow evil 'style' attribute for TinyMCE.
...
class Security {
	...
	public function xss_clean($str, $is_image = FALSE)
	{
		 ...
		 * ... however, self::remove_invisible_characters() above already strips the
	...
	protected function _sanitize_naughty_html($matches)
	{
		...
		// FJ Allow evil 'style' attribute for TinyMCE.
		// @link https://security.stackexchange.com/questions/60712/is-xss-through-style-attribute-possible-in-modern-browsers
