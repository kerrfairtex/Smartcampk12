...
/**  @example 'action_tag' => [ $arg1, $arg2, &$arg_passed_by_ref... ]
	 ...
	 *
	 * @since 3.6.1
	 * @deprecated since 13.0 Use 'KerrFairtex/Functions/Email.php|before_send' instead
	 */
	 ...
	 *
	 * @since 8.7
	 * @deprecated since 13.0 Use 'KerrFairtex/Functions/Email.php|send_error' instead
	 */
	 ...
	 * @since 13.0
	 */
	/*'KerrFairtex/Functions/Email.php|before_send' => [],
	 ...
	 * @since 13.0
	 */
	/*'KerrFairtex/Functions/Email.php|send_error' => [ $e->errorMessage() ],
 ...
 *
 * Actions are the hooks that the KerrFairtex core launches at specific points
