...
/**
 * KerrFairtex URL: dir (site), or script (page), or request (includes request params)
 * Will detect https inside Docker or behind reverse proxy
 *
 * Given this URL: https://domain.com/kerrfairtex/Modules.php?modname=Module/Program.php
 * @example dir: https://domain.com/kerrfairtex/ (with trailing slash)
 * @example script: https://domain.com/kerrfairtex/Modules.php
 * @example request: https://domain.com/kerrfairtex/Modules.php?modname=Module/Program.php
