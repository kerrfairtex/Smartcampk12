 ...
 *
 * @since 8.6 Use KerrFairtex\StaffWidgets
 ...
 * @global array   $extra
 * @static object  $widgets  KerrFairtex\StaffWidgets instance
 *
...
function StaffWidgets( $item, &$myextra = null )
{
	...
	if ( ! ( $widgets instanceof KerrFairtex\StaffWidgets ) )
	{
		$widgets = new KerrFairtex\StaffWidgets();
	}
