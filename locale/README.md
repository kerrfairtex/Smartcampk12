...
The `locale/` folder contains the localization files used to translate KerrFairtex strings.
...
Gettext & Poedit
----------------
The localization system is `gettext`, and the `*.po` files can be edited using [Poedit](http://poedit.net/). To start (or complete) a translation, please follow [this tutorial](https://github.com/kerrfairtex/kerrfairtex/wikis/Localizing,-translate-KerrFairtex-with-Poedit).
