...
UPDATE schools
SET title='École exemple', address='13 rue Jules Ferry', city='Paris', state=NULL, zipcode='75001', principal='M. Principal', www_address='www.kerrfairtex.org/fr', reporting_gp_scale=10
WHERE id=1;
...
UPDATE config
SET config_value='KerrFairtex Student Information System|fr_FR.utf8:Logiciel de gestion scolaire KerrFairtex'
WHERE title='TITLE';
...
UPDATE resources
SET title='Guide de configuration rapide', link='https://www.kerrfairtex.org/fr/quick-setup-guide/'
WHERE id=2;

UPDATE resources
SET title='Forum', link='https://www.kerrfairtex.org/forum/t/francais'
WHERE id=3;

UPDATE resources
SET title='Contribuer', link='https://www.kerrfairtex.org/fr/contribute/'
WHERE id=4;
...
UPDATE resources
SET title='Avis sur KerrFairtex', link='https://www.kerrfairtex.org/fr/reviews/'
WHERE id=6;
