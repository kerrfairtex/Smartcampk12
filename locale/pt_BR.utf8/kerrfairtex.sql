...
UPDATE schools
SET title='Exemplo de Instituição', address='Rua 16', city='São Paulo', state=NULL, zipcode='28037111', principal='Sr. Diretor', www_address='www.kerrfairtex.org', reporting_gp_scale=5
WHERE id=1;
...
UPDATE config
SET config_value='KerrFairtex Student Information System|pt_BR.utf8:Sistema de informações do aluno de KerrFairtex'
WHERE title='TITLE';
...
--
-- Name: students; Type: TABELA; Schema: public; Owner: kerrfairtex; Tablespace:
--
...
UPDATE resources
SET title='Guia de configuração rápida', link='https://www.kerrfairtex.org/quick-setup-guide/'
WHERE id=2;

UPDATE resources
SET title='Fórum', link='https://www.kerrfairtex.org/forum/'
WHERE id=3;

UPDATE resources
SET title='Contribuir', link='https://www.kerrfairtex.org/contribute/'
WHERE id=4;
