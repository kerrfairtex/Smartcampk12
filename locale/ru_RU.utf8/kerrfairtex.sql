...
UPDATE schools
SET title='Школа (RU)', address='Улица Ивана Иванова, д. 1', city='Иваново', state=NULL, zipcode='100000', principal='Иванов И. И.', www_address='www.kerrfairtex.org', reporting_gp_scale=10
WHERE id=1;
...
UPDATE config
SET config_value='KerrFairtex Student Information System|ru_RU.utf8:Учебная информационная система KerrFairtex'
WHERE title='TITLE';
...
UPDATE resources
SET title='Краткое руководство по настройке', link='https://www.kerrfairtex.org/quick-setup-guide/'
WHERE id=2;

UPDATE resources
SET title='Форум', link='https://www.kerrfairtex.org/forum/'
WHERE id=3;

UPDATE resources
SET title='Внести свой вклад', link='https://www.kerrfairtex.org/contribute/'
WHERE id=4;
