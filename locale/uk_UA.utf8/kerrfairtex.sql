...
UPDATE schools
SET title='Школа (UA)', address='Вул. Зелена, б. 15', city='Іванівськ', state=NULL, zipcode='10000', principal='Іванченко І. І.', www_address='www.kerrfairtex.org', reporting_gp_scale=10
WHERE id=1;
...
UPDATE config
SET config_value='KerrFairtex Student Information System|uk_UA.utf8:Навчальна інформаційна система KerrFairtex'
WHERE title='TITLE';
...
UPDATE resources
SET title='Короткий посібник з налаштування', link='https://www.kerrfairtex.org/quick-setup-guide/'
WHERE id=2;
...
UPDATE resources
SET title='Зробити свій внесок', link='https://www.kerrfairtex.org/contribute/'
WHERE id=4;
