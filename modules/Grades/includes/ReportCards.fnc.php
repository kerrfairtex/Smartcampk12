...
function _getAttendanceDayRET( $st_list, $last_mp )
{
	...
	trigger_error(
		'_getAttendanceDayRET() function is deprecated since KerrFairtex 12.0. Use _getDailyAbsencesMP() instead.',
		E_USER_DEPRECATED
	);
...
function _getAttendanceRET( $st_list )
{
	...
	// Raise deprecation notice.
	trigger_error(
		'_getAttendanceRET() function is deprecated since KerrFairtex 12.0. Use _getOtherAttendanceMP() instead.',
		E_USER_DEPRECATED
	);
