...
// Core modules (packaged with KerrFairtex):
	...
	&& AllowEdit() )
{
	...
	else
	{
		...
		(new KerrFairtex\Functions\AddonInfo( 'module', $_REQUEST['module'] ))->checkRequirements();
	}
...
if ( ! $_REQUEST['modfunc'] )
{
	...
	$modules_url = 'https://www.kerrfairtex.org/' .
