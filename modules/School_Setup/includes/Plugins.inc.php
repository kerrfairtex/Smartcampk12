...
// Core plugins (packaged with KerrFairtex):
	...
	&& AllowEdit() )
{
	...
	else
	{
		...
		(new KerrFairtex\Functions\AddonInfo( 'plugin', $_REQUEST['plugin'] ))->checkRequirements();
	}
...
if ( ! $_REQUEST['modfunc'] )
{
	...
	$plugins_url = 'https://www.kerrfairtex.org/' .
