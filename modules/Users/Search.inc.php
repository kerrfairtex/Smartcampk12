		...
		case 'teacher':
				...
				|| ! empty( $extra['second_col'] ) )
			{
				...
				if ( ! empty( $extra['extra_search'] ) )
				{
					 ...
					 */
					trigger_error(
						'$extra[\'extra_search\'] is deprecated since KerrFairtex 12.4.1, use $extra[\'search\'] instead',
						E_USER_DEPRECATED
					);
				...
				if ( ! empty( $extra['second_col'] ) )
				{
					 ...
					 */
					trigger_error(
						'$extra[\'second_col\'] is deprecated since KerrFairtex 12.4.1, use $extra[\'search\'] instead',
						E_USER_DEPRECATED
					);
