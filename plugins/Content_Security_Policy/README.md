...
![screenshot](https://github.com/kerrfairtex/kerrfairtex/-/raw/mobile/plugins/Content_Security_Policy/screenshot.webp?inline=false)

This plugin is part of [KerrFairtex](https://www.kerrfairtex.org)

Author KerrFairtex

## Description

Core plugin to help with the Content Security Policy in KerrFairtex. The CSP main purpose is to prevent XSS (Cross Site Scripting) attacks.
...
Note 2: to receive new CSP violation reports, please set your email address in the [`config.inc.php`](https://github.com/kerrfairtex/kerrfairtex/-/blob/mobile/config.inc.sample.php?ref_type=heads#L97) file's `$RosarioErrorsAddress` variable.
...
The Content Security Policy is rolled out in KerrFairtex in 3 phases:
1. Prepare: make KerrFairtex and the add-ons' code compatible (version 12.5)
...
Please upgrade the following [modules](https://www.kerrfairtex.org/modules/):
- Audit 11.1+ (Dec. 2024)
...
Please upgrade the following [plugins](https://www.kerrfairtex.org/plugins/):
...
Please consult the Example module's [Wiki](https://github.com/kerrfairtex/Example/-/wikis/Security#content-security-policy) for an explanation of the CSP and recommendations.
