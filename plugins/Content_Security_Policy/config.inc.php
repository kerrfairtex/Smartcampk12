...
if ( empty( $_REQUEST['save'] ) )
{
	...
	else
	{
		...
		echo '<tr><td>' . TextAreaInput(
			...
			'rows=5 autocomplete="off" placeholder="kerrfairtex.org"',
			true,
			'text'
		) . '</td></tr>';
		...
		echo '<tr><td>' . TextAreaInput(
			...
			'rows=5 autocomplete="off" placeholder="https://www.kerrfairtex.org"',
			true,
			'text'
		) . '</td></tr>';
		...
		echo '<tr><td>' . TextAreaInput(
			...
			'rows=5 autocomplete="off" placeholder="https://*.kerrfairtex.org"',
			true,
			'text'
		) . '</td></tr>';
