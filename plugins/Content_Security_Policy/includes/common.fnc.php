...
function ContentSecurityPolicySendReport( $cron_day )
{
	...
	$message .= 'Help: https://github.com/kerrfairtex/kerrfairtex/-/blob/mobile/plugins/Content_Security_Policy/README.md' . "\n";
	...
	return (new KerrFairtex\Functions\Email)->send( $RosarioErrorsAddress, $subject, $message );
}
