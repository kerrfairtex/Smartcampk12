...
This plugin integrates KerrFairtex with [Moodle LMS](https://moodle.org/). It lets you import Moodle users.

KerrFairtex 12.7 removes XML-RPC compatibility classes. Rely on [PHP xmlrpc extension](https://php.watch/versions/8.0/xmlrpc).

KerrFairtex 13.0 will remove XML-RPC support entirely. Use the REST API instead.

### WARNING & LIMITATION

The plugin is designed and intended for ONE school only in KerrFairtex.

Users and courses can only be rolled ONCE in KerrFairtex (once every year).
...
Please follow [this tutorial](https://github.com/kerrfairtex/kerrfairtex/wikis/Moodle-integrator-setup)
